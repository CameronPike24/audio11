...
class AudioPlayer:
    def __init__(self, channels, rate, chunk_size):
        ...
        self.mic = get_input(callback=self.micCallback, rate=44100, source='default', buffersize=512, channels=1,encoding=16) # initialises the method get_input from the module with the properties required   
