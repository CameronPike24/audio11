...
class AudioPlayer:
    def __init__(self, channels, rate, chunk_size):
        ...
        self.mic = get_input(callback=self.micCallback, rate=48000, source='default', buffersize=2048) # Default is 44100 not working. try 8000, 11025, 16000, 22050, 44100, 48000
